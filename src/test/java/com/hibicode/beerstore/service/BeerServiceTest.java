...
public class BeerServiceTest {
    ...
    public void should_deny_creation_of_beer_that_exists() {
        ...
        when(beersMocked.findByNameAndType("Heinaken", BeerType.LAGER)).thenReturn(Optional.of(beerInDatabase));

        Beer newBeer = new Beer();
        newBeer.setName("Heinaken");
    ...
    @Test
    public void sould_create_new_beer(){
        Beer newBeer = new Beer();
        newBeer.setName("Heinaken");
        newBeer.setType(BeerType.LAGER);
        newBeer.setVolume(new BigDecimal("355"));
        ...
        when(beersMocked.save(new Beer())).thenReturn(newBeerInDatabase);
